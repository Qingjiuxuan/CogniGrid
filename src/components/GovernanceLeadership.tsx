...
import { EXECUTIVE_TEAM, FOUNDATION_GOVERNANCE_OVERVIEW } from '../data';
              ...
              >
                <div>
                  ...
                  <div className="relative w-full aspect-[4/5] bg-slate-100 overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 via-transparent to-transparent opacity-60 group-hover:opacity-40 transition-opacity pointer-events-none" />
